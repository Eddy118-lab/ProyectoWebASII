...
import './Style/StyleProveedor.css';  // Asegúrate de crear este archivo para estilos específicos

const URI_PROVEEDOR = 'http://localhost:8000/api/proveedores/';
const URI_TIPO_PROVEEDOR = 'http://localhost:8000/api/tipos-proveedores/';
