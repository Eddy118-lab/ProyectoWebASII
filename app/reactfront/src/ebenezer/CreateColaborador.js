...
const CompCreateColaborador = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(URI_COLABORADOR, newGestionPersonal);
    ...
    return (
        <div className='form-container'>
            <h2 className='form-title'>Crear Colaborador</h2>
...
export default CompCreateColaborador;